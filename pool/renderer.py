...
class Renderer:
	...
	def render_text(self, txt, fonte, cor, pos, justifyX:Literal['center','left','right']='center', justifyY:Literal['middle','top','bottom']='middle'): # inspirado pelo canal Coding With Russ (https://www.youtube.com/watch?v=ndtFoWWBAoE)
